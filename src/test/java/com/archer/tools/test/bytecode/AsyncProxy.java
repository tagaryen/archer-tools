...
public class AsyncProxy {
	...
	private static final String ASYNC_TYPE = "Lcom/archer/tools/test/bytecode/Async;";
	private static final String THREADPOOL_CLASS = "com/archer/tools/test/bytecode/AsyncPool";
	private static final String THREADPOOL_TYPE = "Lcom/archer/tools/test/bytecode/AsyncPool;";
	private static final String POOL_NAME = "pool";
	private static final String SUBMIT_TASK_CLASS = "com/archer/tools/test/bytecode/AsyncTask";
	private static final String SUBMIT_TASK_TYPE = "Lcom/archer/tools/test/bytecode/AsyncTask;";
